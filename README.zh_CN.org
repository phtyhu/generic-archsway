...
- 很好上手！
  ...
  - (WIP) 引导非常详尽。
- 适合长期使用！
  - 本项目借助 git 与 [[https://github.com/anishathalye/dotbot][dotbot]] 管理一切配置（包括你自己的配置，比如 Emacs 的 =~/.emacs.d= ）。
...
** 贡献
欢迎参与贡献。
你可以创建 [[https://github.com/phtyhu/generic-archsway][Pull Requests]]，[[https://github.com/phtyhu/generic-archsway][issues]] 等。
